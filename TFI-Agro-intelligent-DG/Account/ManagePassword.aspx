    ...
    <div class="form-horizontal">
        <section id="passwordForm">
            <asp:PlaceHolder runat="server" ID="setPassword" Visible="false">
                <p>
                    No tiene una contraseña local para este sitio. Agregar un local
                        contraseña para que pueda iniciar sesión sin un inicio de sesión externo.
                </p>
                <div class="form-horizontal">
                    <h4>Formulario de contraseña</h4>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="password"
                                ...
                                Display="Dynamic" ValidationGroup="Configurar la contraseña" />
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            ...
                            <asp:RequiredFieldValidator runat="server" ControlToValidate="NewPassword"
                                CssClass="text-danger" ErrorMessage="Se requiere la nueva contraseña."
                                ValidationGroup="ChangePassword" />
                        </div>
                    </div>
                    <div class="form-group">
